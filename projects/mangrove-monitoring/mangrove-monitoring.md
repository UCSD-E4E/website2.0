...
![]({{"assets/mangrove/projects-mangrove-aburto_lab_photos.jpg" | absolute_url}})
...
![]({{"assets/mangrove/projects-mangrove-services_and_loss.jpg" | absolute_url}})
...
![]({{"assets/mangrove/projects-mangrove-species_classification.jpg" | absolute_url}})

# Spring 2018 Update

Mangrove Monitoring in Puerto San Carlos

![]({{"assets/mangrove/projects-mangrove-Day1_full-Team-768x465.jpg" | absolute_url}})
...
![]({{"assets/mangrove/projects-mangrove-labeled_survey-768x474.jpg" | absolute_url}})
...
![]({{"assets/mangrove/projects-mangrove-IMG_9850-768x512.jpg" | absolute_url}})
