...
<div class="floatclearfix">
    {% if student.photo %}
    <p style="display: float; justify-content: center;"><a href="{{ student.photo | absolute_url }}"><img alt="{{ student.name | default: 'Student photo' }}" class="{{student.align}}" src="{{student.photo | resize: '180x240'}}"></a></p>{% endif %}
    <p>{{student.bio}}</p>
</div>
{% endfor %}
